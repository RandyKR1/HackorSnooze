...
class StoryList {
  ...
  async addStory( user, {title, author, url}) {
    const token = user.loginToken; //gathering user authentication
    const response = await axios({ 
      method: "POST", //declaring a post request
      url: `${BASE_URL}/stories`, //to the stories portion of the URL
      data: { token, story: { title, author, url } }, // with the data representing the story's title, author,and url
    });
